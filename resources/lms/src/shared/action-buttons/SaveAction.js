...
const SaveAction = ({ onSave, onCancel, invalid, isHideCancel, pristine, isDisableSubmit = false, newBookItem, isCreateInEdit }) => {
    return (
        <div className="save-action">
            ...
            <Button onClick={onSave} disabled={invalid || pristine || isCreateInEdit ? false : isDisableSubmit} color="primary" size="md"
