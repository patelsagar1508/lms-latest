        ...
        <Row className="animated fadeIn">
            <Col sm={12} className="mb-2">
                ...
                <div className="d-flex justify-content-end">
                    <Dropdown>
                        <Dropdown.Toggle className="btn btn-primary ml-2 text-white" id="dropdown-basic" >
                            {getFormattedMessage('react-data-table.action.column')}
                        </Dropdown.Toggle>
                        <Dropdown.Menu className="p-0">
                            <Dropdown.Item href={`#${Routes.BOOKS}new`} className="header__border">
                                {getFormattedMessage('books.input.new-btn.label')}
                            </Dropdown.Item>
                            <Dropdown.Item href={`#${Routes.BOOKS}import-book`} className="header__border">
                                {getFormattedMessage('books.input.import-btn.label')}
                            </Dropdown.Item>
                            <Dropdown.Item onClick={() => onClickModal()} className="header__border">
                                {getFormattedMessage('books.import-file-btn.label')}
                            </Dropdown.Item>
                            <Dropdown.Item onClick={() => onClickExport()} className="header__border">
