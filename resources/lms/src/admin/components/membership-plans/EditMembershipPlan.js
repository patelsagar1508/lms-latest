...
const EditMembershipPlan = (props) => {
    ...
    const { name, membership_plan_id, price, issue_books_limit,reserve_books_limit, frequency
        // stripe_plan_id
        , description } = membershipPlan;
    const membershipFrequencyOptions = getFormattedOptions(membershipPlanFrequencyOptions);
    const changeAbleFields = {
        name, membership_plan_id, price,issue_books_limit,reserve_books_limit,
        // stripe_plan_id
        description,
