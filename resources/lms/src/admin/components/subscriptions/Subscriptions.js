...
const Subscriptions = (props) => {
    ...
    const cardModalProps = {subscription, isCreate, isEdit, isDelete, toggleModal};
...
export default connect(mapStateToProps, {toggleModal, fetchSubscriptions, setActiveInactiveSubs})(Subscriptions);
