...
import {resetSearchBooks, resetAllSearchBooks} from "../../store/actions/bookSearchAction";

const BookSearchForm = (props) => {
    const {
        books, authors, change, onSearchBook, resetSearchBooks, resetAllSearchBooks, setSearch, handleSubmit, isAuthorSelected,
            ...
            <div className="d-flex justify-content-center">
                <div className="flex-2 justify-content-center text-center">
                    ...
                    <Col xs={12} className="book-form__btn">
                        <Button onClick={handleSubmit(searchBook)} disabled={isDisabled} color="primary text-white">
...
export default connect(null, { resetSearchBooks,resetAllSearchBooks })(bookSearchForm);
