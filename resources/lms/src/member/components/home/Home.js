...
const Home = (props) => {
    ...
    const appLogo = '/public/images/logo.png'; //appSetting[appSettingsKey.LIBRARY_LOGO] ? appSetting[appSettingsKey.LIBRARY_LOGO].logo_url : publicImagePath.APP_LOGO;
    let about = undefined;
    const modalOptions = {
        toggleModal,
        isToggle,
    ...
    const onSearchByApi = (searchBy = 'book', page = 0) => {
    ...
    const inputHandleKeyPress = (event) => {
        if(event.key == 'Enter'){
           onSearch();
        }
     }
            ...
            <section className={ `${ genres.length === 0 ? 'section-spacing--no-item' : 'section-spacing--top section-spacing--bottom' } category`}>
                <div className="container">
                    ...
                    <p className={ `${genres.length === 0 ? 'm-0' : 'section-header-row-spacing'} text-center text-description--white-section text-description section-width mx-auto`}>
                        {homeSettings.genres_text ? homeSettings.genres_text.value : null }
                    </p>
                    <div className="row">
                        {
            ...
            <section className="popular-book section-spacing--top section-spacing--bottom position-relative">
                ...
                <div className="container-fluid popular-book__container">
                    ...
                    <p className="section-header-row-spacing text-center w-75 ml-auto mr-auto">
                        {homeSettings.popular_books_text ? homeSettings.popular_books_text.value : null}
                    </p>
    ...
    const renderSearchedBooks = () => {
        ...
        return (
            <section className="book-search section-spacing--top section-spacing--bottom" ref={(el) => {
                ...
                <div className="container">
                  { (isSearch) ?  <h2 className="book-search__result-heading text-description text-center">Result for</h2> : null }
                  { (isSearch) ?   <h1 className="book-search__book-name text-center mb-5">"{search}"</h1> : null }
    ...
    const tabOptions = {onChangeInput, onSearch, inputHandleKeyPress};
    /**
     * Render Footer
     * @returns {*}
     */
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-md-3">
                            ...
                            <p className="mt-3">
                                {homeSettings.company_description ? homeSettings.company_description.value : null}
                            </p>
                            <div className="space-10"/>
                            <ul className="list-inline list-unstyled social-list">
                                <li className="list-inline-item">
                                    <a href={homeSettings.facebook ? homeSettings.facebook.value : null} target="_blank">
                                        <i className="fa fa-facebook" aria-hidden="true"/>
                                    </a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={homeSettings.twitter ? homeSettings.twitter.value : null}
                                       target="_blank">
                                        <i className="fa fa-twitter" aria-hidden="true"/>
                                    </a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={homeSettings.linkedin ? homeSettings.linkedin.value : null} target="_blank">
                                        <i className="fa fa-linkedin" aria-hidden="true"/>
                                    </a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={homeSettings.github ? homeSettings.github.value : null} target="_blank">
                        ...
                        <div className="col-12 col-md-4 ml-auto">
                            ...
                            <table className="table borderless addr-dt">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href={`mailto: ${homeSettings.contact_email ? homeSettings.contact_email.value : null}`}
                                           target="" className="footer__link">
                                            {homeSettings.contact_email ? homeSettings.contact_email.value : null}
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href={`tel:+91 ${homeSettings.contact_phone ? homeSettings.contact_phone.value : null}`}
                                           target="" className="footer__link">
                                            {homeSettings.contact_phone ? homeSettings.contact_phone.value : null}
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href={homeSettings.website ? homeSettings.website.value : null}
                                           target="" className="footer__link">
                                            {homeSettings.website ? homeSettings.website.value.replace('https://', '') : null}
                                        </a>
                                    </td>
                                </tr>
                                </tbody>
    ...
    const renderAboutUs = () => {
        return (
            <section className={ `${ aboutUsCard.length === 0 ? 'section-spacing--no-item' : 'section-spacing--top section-spacing--bottom' } about-us`}>
                <div className="container">
                    <h3 className="text-center">{homeSettings.about_us_text ? homeSettings.about_us_text.display_name : null}</h3>
                    <p className={ `${aboutUsCard.length === 0 ? 'm-0' : 'section-header-row-spacing'} text-center text-description section-width mx-auto`}>
                        {homeSettings.about_us_text ? homeSettings.about_us_text.value : null}
                     </p>
                    <div className="row">
                        {
