...
const MemberProfileForm = (props) => {
    ...
    return (
        <Row className="animated fadeIn member-form m-3 px-1">
            <Col xs={12} sm={12} md={12} lg={8} className="primary-detail">
            ...
            <Col xs={12} sm={12} md={12} lg={4} className="member-profile">
