...
var Login = function Login(props) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    if (localStorage.getItem(_constants__WEBPACK_IMPORTED_MODULE_4__.Tokens.ADMIN)) {
      history.push(_constants__WEBPACK_IMPORTED_MODULE_4__.Routes.ADMIN_DEFAULT);
    }
    initialize((0,_shared_sharedMethod__WEBPACK_IMPORTED_MODULE_8__.getLocalStorageDataByEncryptKey)('currentUser'));
